      ...
      <div className="app">
        ...
        <div className='container'>
          ...
          <div className='heading-text'>
            ...
            <p className='title-par'>CALCULATE YOUR SIMPLE INTEREST</p>
          ...
          <div className='amount-card'>
            ...
            <div className='card-text'>
              ...
              <h3 className='total-amout'>₹{interest}</h3>
          ...
          <form onSubmit={calculateInterest}>
            ...
            <div className='btn-group'>
              ...
              <Stack direction="row" spacing={2}>
                <Button type='submit' className='btn' style={{backgroundColor:'blue'}} variant="contained">Calculate </Button>
